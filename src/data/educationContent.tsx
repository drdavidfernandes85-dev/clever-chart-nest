...
const VideoBody_EN = () => (
  <>
    <P>Theory becomes intuition when you watch real traders execute in real markets. Our live webinars and on-demand video library are <strong>free for every member</strong> of the IX Live Trading Room.</P>
    <UL>
...
const VideoBody_ES = () => (
  <>
    <P>La teoría se convierte en intuición cuando ves a traders reales ejecutar en mercados reales. Nuestros webinars en vivo y la videoteca bajo demanda son <strong>gratis para cada miembro</strong> de la IX Live Trading Room.</P>
    <UL>
...
const VideoBody_PT = () => (
  <>
    <P>A teoria vira intuição quando você assiste traders reais executando em mercados reais. Nossos webinars ao vivo e a videoteca sob demanda são <strong>gratuitos para todos os membros</strong> da IX Live Trading Room.</P>
    <UL>
