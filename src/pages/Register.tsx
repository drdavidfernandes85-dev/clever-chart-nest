  ...
  return (
    <div className="relative flex min-h-screen overflow-hidden">
      <SEO
        ...
        description="Create your free account and join the IX Sala de Trading — live forex analysis, trade ideas and a pro community."
        ...
        <div className="w-full max-w-sm space-y-8">
          <div className="text-center">
            <Link to="/" className="inline-flex flex-col items-center gap-2">
              <LtrLogo variant="full" className="text-2xl" />
            </Link>
            <div className="mx-auto mt-4 h-0.5 w-8 bg-[#FFCD05]" />
            <h1 className="mt-4 font-heading text-2xl font-semibold text-[#FFCD05] uppercase tracking-[0.08em]">{t("register.title")}</h1>
          </div>
