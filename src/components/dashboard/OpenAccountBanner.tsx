...
const CONTENT: Record<Locale, Content> = {
  en: {
    ...
    body: "Full access to the IX LTR requires a verified live Infinox account with a minimum net balance of $100 USD.",
  ...
  es: {
    ...
    body: "El acceso completo al IX LTR requiere una cuenta Infinox real verificada con un saldo neto mínimo de $100 USD.",
  ...
  pt: {
    ...
    body: "Acesso completo ao IX LTR requer uma conta Infinox real verificada com saldo líquido mínimo de $100 USD.",
