...
const HeroSection = () => {
  ...
  return (
    ...
    >
      {/* ── HERO COMET BACKGROUND IMAGE — constrained to centered container ─── */}
      <div className="pointer-events-none absolute inset-0 z-0">
        ...
        {/* Centered container that holds the comet + glows so they align with hero content */}
        <div className="relative mx-auto h-full w-full max-w-[1400px]">
          {/* Massive pulsing yellow halo behind the logo zone */}
          <div
            className="absolute top-1/2 right-[8%] -translate-y-1/2 h-[620px] w-[620px] rounded-full animate-pulse-glow"
            style={{
              background:
          ...
          <div
            className="absolute top-1/2 right-[12%] -translate-y-1/2 h-[300px] w-[300px] rounded-full animate-pulse-glow"
            style={{
              background:
          ...
          <img
            ...
            alt=""
            aria-hidden
            className="absolute inset-y-0 right-0 h-full w-[55%] object-contain object-right select-none animate-breathe"
            style={{
              filter:
