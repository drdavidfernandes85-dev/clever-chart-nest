...
## Core
Elite Live Trading Room for Infinox LATAM community. Yellow branding hsl(45,100%,50%). Dark theme bg hsl(220,20%,8%) — Infinox style.
Space Grotesk headings, Inter body. Supabase Cloud backend. SSO integration with Infinox client portal.

## Memories
- [Branding](mem://design/branding) — Yellow/gold accent color, Infinox-inspired dark theme, Elite Live Trading Room name
